...
const nextStatus = { new: 'picked up', 'picked up': 'dropped off', 'dropped off': 'done', 'in progress': 'done' }
const nextLabel = { new: 'Mark picked up', 'picked up': 'Mark dropped off', 'dropped off': 'Mark complete', 'in progress': 'Mark complete' }
const prevStatus = { 'picked up': 'new', 'dropped off': 'picked up', done: 'dropped off', 'in progress': 'new' }
